...
sub is_dbxref_legal {
  ...
  elsif ($_ =~ m/FlyBase\:FBrf\d{7}|VFB_vol\:\d{8}|FBC\:\S+|FlyBase\:FBim\d{7}|PMID\:\d+|http\:\/\/.+|CARO\:\S+|doi\:\d+\.\d+\/\w+|FlyBrain_NDB\:\d+|CHEBI\:\d+|MeSH\:D\d+|GOC:\S+|GO_REF\:\d+|Reactome\:\d+|SO\:\S+|UniProt\:P\d+|UniProt\:Q\d+|WB_REF\:\S+|FB\:FBrfd{7}|Wikipedia\:\S+/) {
    $legal_stat=1;
  } else {
    $legal_stat=0
  }
