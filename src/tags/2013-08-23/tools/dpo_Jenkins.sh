...
PC_def_update.pl ontologies/dpo-edit.obo > tmp.obo # Pull defs from named equivalent class to FBcv (from EC CHEBI terms)
...
owltools tmp.obo --merge lethal_phase_imports_merged.owl --merge ontologies/fbcv_auth_attrib_licence.owl -o file://`pwd`/dpo_merged.owl
