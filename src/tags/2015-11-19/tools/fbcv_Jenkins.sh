...
PC_def_update.pl src/trunk/ontologies/fbcv-edit.obo > tmp.obo # Pull defs from named equivalent class to FBcv (from EC CHEBI terms)
...
owltools tmp2.obo --merge lethal_phase_imports_merged.owl --merge src/trunk/ontologies/fbcv_auth_attrib_licence.owl -o file://`pwd`/fbcv_merged.owl
