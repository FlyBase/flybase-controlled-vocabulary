...
PC_def_update.pl fbcv/src/trunk/ontologies/dpo-edit.obo > tmp.obo # Pull defs from named equivalent class to FBcv (from EC CHEBI terms)
...
owltools tmp.obo --merge lethal_phase_imports_merged.owl --merge fbcv/src/trunk/ontologies/fbcv_auth_attrib_licence.owl -o file://`pwd`/dpo_merged.owl
