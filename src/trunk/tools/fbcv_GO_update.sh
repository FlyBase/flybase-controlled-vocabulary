...
owltools $FBCV_BUILD_PATH/fbcv-non-classified.owl $OBO/go/go-basic.obo --add-imports-from-supports --extract-module -c -s $OBO/go.owl --set-ontology-id $OBO/fbcv_go_import.owl -o fbcv_go_import.owl  # Seems that source must be specified as URL.
