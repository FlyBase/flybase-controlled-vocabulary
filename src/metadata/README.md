 ...
 * [fbcv.yml](fbcv.yml)
     * Determines how your purl.obolibrary.org/obo/fbcv/ redirects will be handled
     ...
     * Paste in the contents of [fbcv.yml](fbcv.yml)
 ...
 * [fbcv.md](fbcv.md)
     ...
     * Paste in the contents of [fbcv.md](fbcv.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
