...
Make sure you have an ID range in the [idranges file](fbcv-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [fbcv-edit.owl](fbcv-edit.owl)
 ...
 * [fbcv-idranges.owl](fbcv-idranges.owl)
...
There are two ways to include new classes in an import module
 ...
 2. Add to the imports/fbcv_terms.txt file
...
This generates derived files such as fbcv.owl and fbcv.obo and places
...
what is in the `owl:versionIRI` of the derived fbcv.owl (`data-version` in
fbcv.obo). This will be today's date.
